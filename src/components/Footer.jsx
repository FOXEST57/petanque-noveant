        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              {siteSettings.clubDescription || "Un club convivial et dynamique qui rassemble les passionnés de pétanque de tous âges dans une ambiance chaleureuse et sportive."}
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center text-gray-300">
              ...
              <span className="text-sm">
                {siteSettings.address || 'Veloroute Charles le téméraire\n57680 Novéant-sur-Moselle, France'}
              </span>
            </div>
          ...
          <div>
            ...
            <div className="flex items-start mb-4 space-x-3">
              <Clock className="w-5 h-5 text-[var(--primary-color)] mt-0.5 flex-shrink-0" />
              ...
              <div className="flex space-x-3">
                {siteSettings.facebookUrl && (
                  <a 
                    ...
                    className="text-[var(--primary-color)] transition-colors duration-200 hover:text-[var(--primary-dark)]"
                    aria-label="Facebook"
                    target="_blank"
        ...
        <div className="pt-8 mt-8 border-t border-gray-800">
          <div className="flex flex-col justify-between items-center md:flex-row">
            <p className="mb-4 text-sm text-gray-400 md:mb-0">
              © 2025 Kreacode. Tous droits réservés.
            </p>
