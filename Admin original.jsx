            ...
            const eventsWithPhotos = await Promise.all(
                eventsData.map(async (event) => {
                    try {
                        ...
                        const response = await fetch(`${import.meta.env.VITE_API_URL}/api/events/${event.id}/photos`);
                                                    ...
                                                    {member.photo_url ? (
                                                        <img
                                                            src={member.photo_url.startsWith('/uploads/') || member.photo_url.startsWith('uploads/') ? 
                                                                `${import.meta.env.VITE_API_URL}/api/members/photos/${member.photo_url.split('/').pop()}` : 
                                                                member.photo_url}
